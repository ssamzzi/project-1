...
export const toolMetas: ToolMeta[] = [
  { id: 'pcr-master-mix', slug: 'pcr-master-mix', nameEn: 'PCR/qPCR Master Mix', nameKo: 'PCR/qPCR 마스터믹스', shortEn: 'Reaction planning and component balancing', shortKo: '반응 조성과 성분 비율을 빠르게 점검' },
  { id: 'multi-stock-mix', slug: 'multi-stock-mix', nameEn: 'Multi-Stock Mixing', nameKo: '다중 스톡 혼합', shortEn: 'Mixing many components accurately', shortKo: '여러 시약을 정확하게 혼합' },
  ...
  { id: 'copy-number', slug: 'copy-number', nameEn: 'DNA/RNA Copy Number', nameKo: 'DNA/RNA 카피수 계산', shortEn: 'Convert mass to copies and dilution plan', shortKo: '질량을 copy number와 희석 계획으로 변환' },
  ...
  { id: 'cell-seeding', slug: 'cell-seeding', nameEn: 'Cell Seeding', nameKo: '세포 시딩', shortEn: 'Cell/well and cell/cm² planning', shortKo: 'well당 또는 면적당 세포수 계산' },
  { id: 'hemocytometer', slug: 'hemocytometer', nameEn: 'Hemocytometer', nameKo: '헤모사이토미터', shortEn: 'Counts to viable cells and viability', shortKo: '카운트를 생존 세포수와 생존율로 변환' },
  ...
  { id: 'transformation-efficiency', slug: 'transformation-efficiency', nameEn: 'Bacterial Transformation Efficiency', nameKo: '세균 형질전환 효율', shortEn: 'Calculate CFU/ug and log efficiency', shortKo: 'CFU/ug와 로그 효율 계산' },
];
