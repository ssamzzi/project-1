      ...
      <SectionCard title={isKo ? '편집 정책 및 방법론' : 'Editorial Policy and Methodology'}>
        <div className="space-y-4 text-sm leading-7 text-slate-700">
          ...
          <p>
            ...
            {isKo
              ? '가능한 경우 계산식과 입력값 설명, 가정, 경고 조건, 자주 하는 실수, 관련 워크플로를 함께 제시합니다.'
          ...
          <p>
            ...
            {isKo
              ? '콘텐츠는 일반적인 분자생물학 및 세포생물학 실험 관행을 바탕으로 작성하며 실제 적용 전에는 현장 SOP 검증을 권장합니다.'
          ...
          <p>
            ...
            {isKo
              ? '오류 제보나 업데이트 필요 사항이 있으면 검토 후 반영합니다.'
