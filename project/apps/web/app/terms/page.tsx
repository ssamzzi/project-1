    ...
    <section className="mx-auto max-w-4xl px-4 py-8">
      <SectionCard title={isKo ? '이용약관' : 'Terms of Use'}>
        <div className="space-y-4 text-sm leading-7 text-slate-700">
          <p>
            {isKo
              ? 'BioLT의 계산 결과와 해설은 교육 및 준비 보조 목적입니다. 의료, 임상, 안전 결정의 단독 근거로 사용해서는 안 됩니다.'
          ...
          <p>
            {isKo
              ? '사용자는 최종 판단 전에 실험실 SOP, 제조사 문서, 장비 요구사항, 지도자 검토를 확인해야 합니다.'
          ...
          <p>
            {isKo
              ? '자동 계산 및 AI 기반 분석은 입력 품질과 가정에 따라 달라질 수 있으며, 운영자는 간접 손해에 대해 책임지지 않습니다.'
