          ...
          {tab === "vision" ? (
            <div className="space-y-3">
              ...
              <div className="grid gap-3 lg:grid-cols-2">
                {visionPreview ? <img src={visionPreview} alt="Uploaded image preview for LabOps AI analysis" className="w-full rounded border border-slate-200 bg-white p-2" /> : null}
                {visionOverlay ? <img src={visionOverlay} alt="Analysis overlay preview generated by LabOps AI" className="w-full rounded border border-slate-200 bg-white p-2" /> : null}
              </div>
              {visionRows.length ? (
